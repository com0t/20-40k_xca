...
class VanillaJsLoader extends JsLoader {
    ...
    public function enqueue()
    {
        ...
        if(\ShortPixelAI::userCan( 'manage_options' )) {
            ...
            wp_add_inline_script('spai-snip-action', "if(document.getElementById('shortpixel_ai_sniper') !== null) { 
                document.getElementById('shortpixel_ai_sniper').setAttribute('onclick', 'spaiSniperStart();return false;'); 
            }
            function spaiSniperStart() {
